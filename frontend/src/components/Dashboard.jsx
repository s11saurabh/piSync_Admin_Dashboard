...
//       // Get errors data - IMPORTANT CHANGE: using getAllErrors instead of getRecentErrors
//       const errorsData = await getAllErrors();
//       console.log("Fetched error data:", errorsData);
      
//       // Make sure we're setting the errors state with the data
...
//       fetchData(); // Refetch all data after sync
//     } catch (err) {
